...
namespace DataAccessLayer
{
    public class DALOgrenci
    {
        ...
        {
            SqlCommand komut5 = new SqlCommand("Update TBLOGRENCI set OGRAD=@P1, OGRSOYAD=@P2, OGRSIFRE=@P3, OGRNUMARA=@P4, OGRFOTO=@P5 Where OGRID=@P6",Baglanti.bgl);
            ...
            komut5.Parameters.AddWithValue("@P3", deger.Sifre);
            komut5.Parameters.AddWithValue("@P4", deger.Numara);
